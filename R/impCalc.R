impCalc <- function(skel_outfile, xTest, yTest, lk_col, labelsFrame, with.labels, regPred, classPred,saveModel){
  ...
  # Load list of RData files
  filesRData <- list.files(pattern = paste0(skel_outfile,".*.RData"))
  
  # Load list of _VarImp_ files
  filesVarImp <- list.files(pattern = paste0(skel_outfile,"REGControl_VarImp_"))
